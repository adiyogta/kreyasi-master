...
export class GuestManagementComponent implements OnInit, OnDestroy {
    ...
    private readonly SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxQiwgMKuwnrAWzV2CtGlb8I1pexMjM-ubDX6fA3NzwmIB1dNBEVwYbIbjkrAF1wMWWrw/exec';
...
Terima kasih.`;
    ...
    generateLink() {
        ...
        this.guest.link = `https://anismantep.kreyasi.my.id/${formattedName}`;
      }
    ngOnInit() {
      this.loadGuests();
